...
document.write("<scr"+"ipt src='https://g.csdnimg.cn/notification/1.3.0/notify.js'></scr"+"ipt>");
document.write("<scr"+"ipt src='https://g.csdnimg.cn/notification/1.3.0/main.js'></scr"+"ipt>");
var _gaq = [];
        ...
        <div class="container row center-block ">\
          <ul class="pull-left left-menu clearfix" id="nav-left-menu">\
            ...
            <li class="app-btn"><a href="https://www.csdn.net/app/" title="APP" target="_blank">APP</a>\
              ...
              <img class="eduwx" src="https://csdnimg.cn/public/common/toolbar/images/eduwxfix.png" />\
              </div>\
            </li>\
